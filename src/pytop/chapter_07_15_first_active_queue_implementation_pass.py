"Chapter 07--15 first active queue implementation pass for v1.0.353."
...
VERSION = "v1.0.353"
PREVIOUS_VERSION = "v1.0.352"
LABEL = "Chapter 07--15 first active queue implementation pass"
NEXT_EXPECTED_VERSION = "v1.0.354 active queue implementation regression gate"
EXPECTED_CHAPTER_COUNT = 9
EXPECTED_RECORD_COUNT = 14
EXPECTED_QUEUE_ITEM_COUNT = 6
...
CURRENT_RECORDS = (
    ...
    "docs/packaging/subproject_packaging_policy_v1_0_353.md",
    "docs/reorganization/docs_reorganization_status_v1_0_353.md",
    ...
    "RELEASE_NOTES_v1_0_353.txt",
    "TEST_REPORT_v1_0_353.txt",
    "UPDATE_REPORT_v1_0_353.txt",
    "VERIFY_REPORT_v1_0_353.txt",
    "DATA_PRESERVATION_REPORT_v1_0_353.txt",
)

PREVIOUS_RECORDS = (
    "docs/roadmap/current_active_roadmap_v1_0_352.md",
    "docs/roadmap/active_versioning_roadmap_v1_0_352.md",
    "docs/releases/v1_0_352.md",
    "docs/integration/chapter_07_15/chapter_07_15_active_development_queue_contract_baseline_v1_0_352.md",
    "docs/verification/chapter_07_15_active_development_queue_contract_baseline_v1_0_352.md",
    "src/pytop/chapter_07_15_active_development_queue_contract_baseline.py",
    "tests/core/test_chapter_07_15_active_development_queue_contract_baseline_v352.py",
)

IMPLEMENTATION_QUEUE_ITEMS = (
    "contract_record_loader",
    "chapter_scope_router",
    "active_surface_guard",
    "archive_boundary_guard",
    "implementation_status_renderer",
    "next_regression_gate_pointer",
)

CHECK_KEYS = (
    "current_records_exist",
    "previous_contract_records_preserved",
    "queue_items_declared",
...
def build_packet(root: str | Path = ".") -> ImplementationPacket:
    root = Path(root)
    ...
    vals = {
        ...
        "previous_contract_records_preserved": all((root / r).exists() for r in PREVIOUS_RECORDS),
        "queue_items_declared": len(IMPLEMENTATION_QUEUE_ITEMS) == EXPECTED_QUEUE_ITEM_COUNT and IMPLEMENTATION_QUEUE_ITEMS[0] == "contract_record_loader",
        ...
        "pyproject_version_aligned": 'version = "1.0.353"' in py and "first active queue implementation pass" in py,
        "docs_index_points_to_current_release": "current_active_roadmap_v1_0_353.md" in idx and "v1_0_353.md" in idx,
        "changelog_contains_current_release": "## v1.0.353" in ch and "first active queue implementation pass" in ch,
    ...
    return ImplementationPacket(
        ...
        len(IMPLEMENTATION_QUEUE_ITEMS),
        len(CHECK_KEYS),
        ready,
...
def render_packet(packet: ImplementationPacket | None = None) -> str:
    packet = packet or build_packet()
    items = "\n".join(f"- {item}" for item in packet.queue_items)
