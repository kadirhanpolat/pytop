"""Chapter 07--15 active development queue contract baseline for v1.0.352."""
...
VERSION="v1.0.352"
PREVIOUS_VERSION="v1.0.351"
LABEL="Chapter 07--15 active development queue contract baseline"
NEXT_EXPECTED_VERSION="v1.0.353 first active queue implementation pass"
...
CURRENT_RECORDS=("docs/current_docs_index.md","MANIFEST.md","PROJECT_ROADMAP.md","README.md","CHANGELOG.md","pyproject.toml","docs/roadmap/current_active_roadmap_v1_0_352.md","docs/roadmap/active_versioning_roadmap_v1_0_352.md","docs/packaging/subproject_packaging_policy_v1_0_352.md","docs/reorganization/docs_reorganization_status_v1_0_352.md","docs/releases/v1_0_352.md","docs/integration/chapter_07_15/chapter_07_15_active_development_queue_contract_baseline_v1_0_352.md","docs/verification/chapter_07_15_active_development_queue_contract_baseline_v1_0_352.md","src/pytop/chapter_07_15_active_development_queue_contract_baseline.py","tests/core/test_chapter_07_15_active_development_queue_contract_baseline_v352.py","RELEASE_NOTES_v1_0_352.txt","TEST_REPORT_v1_0_352.txt","UPDATE_REPORT_v1_0_352.txt","VERIFY_REPORT_v1_0_352.txt","DATA_PRESERVATION_REPORT_v1_0_352.txt")
PREVIOUS_RECORDS=("docs/roadmap/current_active_roadmap_v1_0_351.md","docs/releases/v1_0_351.md")
...
def build_packet(root:str|Path='.') -> QueuePacket:
    ...
    vals={'current_records_exist':all((root/r).exists() for r in CURRENT_RECORDS),'previous_records_preserved':all((root/r).exists() for r in PREVIOUS_RECORDS),'active_surface_targets_present':all((root/r).is_dir() for r in ACTIVE_SURFACE_TARGETS),'archive_bundle_integrity_confirmed':bool(arch.get('sha256_matches_manifest') and arch.get('testzip_ok') and arch.get('all_entries_readable') and arch.get('duplicate_entries')==0),'no_active_nested_zip_files':active_nested_zip_paths(root)==(), 'cleanup_deletion_gate_closed':True, 'pyproject_version_aligned':'version = "1.0.352"' in py and 'active development queue contract baseline' in py, 'docs_index_points_to_current_release':'current_active_roadmap_v1_0_352.md' in idx and 'v1_0_352.md' in idx, 'changelog_contains_current_release':'## v1.0.352' in ch and 'active development queue contract baseline' in ch, 'next_release_pointer_declared':'v1.0.353 first active queue implementation pass' in idx or ('v1.0.353 first active queue implementation pass' in ((root/'PROJECT_ROADMAP.md').read_text(encoding='utf-8') if (root/'PROJECT_ROADMAP.md').exists() else ''))}
