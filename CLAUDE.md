...
- **Released v1.0.2 (latest):** Phase 6 P6.2 — **Persistence over Z/p** (`persistent_homology_fp`): `persistence_pairs_fp(filtered, prime)` over F_p for any prime p. Alternating-sign boundary, Fermat modinv. Torsion detection. `is_prime` helper. 23 new tests.
